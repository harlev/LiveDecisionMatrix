...
BAROMETER.load = function(barometer_id) {
  ...
  this.empty_url = "//getbarometer.s3.amazonaws.com/assets/barometer/images/transparent.gif";
  this.feedback_url = '//getbarometer.com/system/feedback_form/' + this.barometer_id;
